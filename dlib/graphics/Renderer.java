...
public interface Renderer
{
	 ...
	 * 
	 * If the renderer chooses to not implement the method, it will do nothing.
	 * 
	 */
	public void begin();
	...
	/**
	 * Sets the fill color to draw in.
	...
	/**
	 * Sets the stroke color to draw in.
	 * @param c the color as a 32-bit ARGB integer
	 */
	...
	public enum ShapeType { POINTS, LINES, LINE_STRIP, TRIANGLES, TRIANGLE_STRIP, TRIANGLE_FAN, QUADS, QUAD_STRIP };
